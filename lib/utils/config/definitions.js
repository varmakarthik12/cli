...
// XXX change the signature here, obj already has the value in it,
// and the def has the key, can be just `flatten(def, obj, flatOptions)`
...
define('script-shell', {
  ...
  `,
  flatten (key, value, obj, flatOptions) {
    flatOptions.scriptShell = value || undefined
  },
})
...
define('shrinkwrap', {
  ...
  `,
  flatten (key, value, obj, flatOptions) {
    definitions['package-lock'].flatten('package-lock', value, obj, flatOptions)
  }
})
