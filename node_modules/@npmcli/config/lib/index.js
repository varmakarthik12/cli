...
class Config {
  ...
  [_checkDeprecated] (key, where, obj, kv) {
    ...
    if (this.deprecated[key]) {
      this.log.verbose('config', key, this.deprecated[key])//, where, obj, kv, new Error('trace').stack, require.main.filename)
      // throw new Error(`Deprecated ${key}: ${this.deprecated[key]} ${require.main.filename}`)
    }
  }
