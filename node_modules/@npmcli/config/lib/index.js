...
class Config {
  ...
  constructor ({
    ...
    for (const [key, def] of Object.entries(definitions)) {
      ...
      if (def.deprecated)
        this.deprecated[key] = deprecated.trim().replace(/\n +/, '\n')
    }
  ...
  set (key, val, where = 'cli') {
    ...
    // update the flattened options object
    for (const { data } of this.data.values()) {
  ...
  [_loadObject] (obj, where, source, er = null) {
    ...
    if (er) {
      ...
      this.flatten(conf.data, this.flat)
    }
  }
  ...
  [_checkDeprecated] (key) {
    ...
    if (this.deprecated[key])
      this.log.verbose('config', k, this.deprecated[key])
  }
